...
export default function Scene() {
  ...
  useEffect(() => {
    ...
    const redDot = createDot(width * 0.55, height * 0.2, 40 * mobileScale, { fill: "#D7261E", textColor: "#8B0000" }, false, shapeData);

    const banner = createBanner(width * 0.74, height * 0.15, 60 * mobileScale, 80 * mobileScale, {
      fill: "#F59E0B",
      text: "",
      font: `800 ${32 * mobileFontScale}px Inter, system-ui, -apple-system, sans-serif`,
      textColor: "#B45309",
      notch: 28 * mobileScale,
    }, false, shapeData);
    ...
    const pill = createPill(width * 0.83, height * 0.45, 60 * mobileScale, 30 * mobileScale, {
      fill: "#F9A8D4",
      text: "",
      font: `900 ${28 * mobileFontScale}px Inter, system-ui, -apple-system, sans-serif`,
      textColor: "#BE185D",
      rotationRad: -0.45,
    }, false, shapeData);
    ...
    const bang = createExclamationMark(
      500, 200,         // x, y
      80,              // total height
      { color:  "#C7EBF0", angleRad: -0.1 },  // options
      false,
      shapeData
    );
    ...
    const glass = createMartiniGlass(
      500, 40,              // x, y
      160,                   // overall height
      { bowlColor: "#BFD5E2", stemColor: "#BFD5E2", baseColor: "#BFD5E2", outlineColor: null },
      false,                 // isStatic
      shapeData
    );
    ...
    const production = createQuarterPie(width * 0.64, height * 0.55, 80 * mobileScale, {
      fill: "#FACC15",
      text: "",
      font: `900 ${26 * mobileFontScale}px Inter, system-ui, -apple-system, sans-serif`,
      textColor: "#A16207",
      rotationRad: Math.PI,
    }, false, shapeData);
    ...
    const cShape = createThickC(width * 0.82, height * 0.65, {
      fill: "#FFEE70",
      outerR: 70 * mobileScale, innerR: 20 * mobileScale,
      startRad: -Math.PI * 0.15, endRad: Math.PI * 1.15,
    }, false, shapeData);

    const blueBagel = createBagel(
      width * 0.88, height * 0.65, 50 * mobileScale, 90 * mobileScale,
      {
        fillColor: "#60A5FA", // blue
        thickness: 70 * mobileScale,
        text: "",
        font: `700 ${42 * mobileFontScale}px Inter`,
    ...
    const textComponent = createTextComponent(
      width * 0.75, height * 0.6, 200 * mobileScale, 80 * mobileScale,
      {
        fill: "white",
        outline: "black",
        outlineWidth: 2,
    ...
    const textComponent2 = createTextComponent(
      width * 0.75, height * 0.6, 180 * mobileScale, 80 * mobileScale,
      {
        fill: "white",
        outline: "black",
        outlineWidth: 2,
    ...
    const textComponent3 = createTextComponent(
      width * 0.95, height * 0.6, 180 * mobileScale, 80 * mobileScale,
      {
        fill: "white",
        outline: "black",
        outlineWidth: 2,
    ...
    const textComponent4 = createTextComponent(
      width * 0.45, height * 0.6, 180 * mobileScale, 80 * mobileScale,
      {
        fill: "white",
        outline: "black",
        outlineWidth: 2,
    ...
    const textComponent5 = createTextComponent(
      width * 0.55, height * 0.6, 180 * mobileScale, 80 * mobileScale,
      {
        fill: "white",
        outline: "black",
        outlineWidth: 2,
    ...
    const textComponent6 = createTextComponent(
      width * 0.44, height * 0.6, 210 * mobileScale, 80 * mobileScale,
      {
        fill: "white",
        outline: "black",
        outlineWidth: 2,
    ...
    const textComponent7 = createTextComponent(
      width * 0.89, height * 0.6, 210 * mobileScale, 80 * mobileScale,
      {
        fill: "white",
        outline: "black",
        outlineWidth: 2,
    ...
    const baseFontSize = width * 0.1 * mobileFontScale;
