...
import {createCircle, createArch, renderArch, createRectangleWithInnerCircles, renderRectangleWithInnerCircles, createStar, renderStar, createEye, renderEye, createMartiniGlass, renderMartiniGlass, createOliveStick, renderOliveStick, createCameraFront, renderCameraFront, createExclamationMark, renderExclamationMark, createSparkStar, renderSparkStar, createCShape, renderCShape} from "../../ui/utils/createShapes2";
  ...
  useEffect(() => {
    ...
    const c = createCShape(
      480, 380, 120,
      {
        ...
        thicknessRatio: 0.36,
        gapAngleRad: 1.15,
        rotationRad: 0,          // opening to the right
        textSide: "outer",
        textDirection: "ccw",    // bottom→top on left side
        textPadRad: 0.18,
        letterSpacing: 2,
      },
      false,
